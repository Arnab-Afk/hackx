...
const NAV_LINKS = [
  ...
  ["#providers", "providers"],
  ["https://github.com/Arnab-Afk/hackx", "docs"],
]
...
export function Navbar() {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1180, margin: "0 auto", padding: "0 24px", height: 56, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        {/* Logo */}
        <Wordmark />
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <a
            ...
            style={{ fontSize: 13, color: "#555", textDecoration: "none", display: "flex", alignItems: "center", gap: 6, transition: "color 0.15s" }}
            onMouseEnter={e => ((e.currentTarget as HTMLElement).style.color = "#fff")}
