      ...
      <main className="flex-1 flex flex-col overflow-y-auto">
        <div className="p-8">
          <header className="flex flex-wrap justify-between items-start gap-4 mb-6">
            <div>
              <p className="text-3xl font-light tracking-tight" style={{ color: "#F9FAFB" }}>Secrets</p>
          ...
          {adding && (
            <div className="mb-6 rounded-3xl p-5 flex flex-col gap-4" style={{ background: "#1a1a1a", border: "1px solid rgba(226,240,217,0.25)" }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    style={{ background: "#111111", border: "1px solid rgba(255,255,255,0.07)", color: "#E5E7EB" }}
          ...
          <div className="rounded-3xl overflow-hidden" style={{ background: "#1a1a1a", border: "1px solid rgba(255,255,255,0.07)" }}>
            <div
              ...
              style={{ gridTemplateColumns: "1fr 120px 80px", color: "#4B5563", borderBottom: "1px solid rgba(255,255,255,0.06)", background: "#111111" }}
            >
              <span>Key</span>
              <span>Created</span>
              <span />
